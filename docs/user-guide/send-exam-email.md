...
>
> 量潮的人才选拔以实际成果为核心：在相对开放的环境中，自主发现并提出有价值的问题，通过自己的方式创造实际成果。完整的考核机制、岗位要求与报名方式都在招聘官网公开（recurit.quanttide.com），建议你先查看再决定。
>
> 如果你暂时不适合直接考核，也可以选择其他路径参与量潮：
>
> - 实训：加入实训基地，通过阶段化任务逐步积累能力
> - 众包：在 crowd.quanttide.com 认领真实任务，用实际交付展示自己
> - 课堂：在 class.quanttide.com 系统学习大数据课程，为后续成长打基础
>
> 各路径的规则与入口都在对应官网公开，你可以按自己的情况选择。
>
