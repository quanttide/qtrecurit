//! 招聘沟通话术模板（referral / training / exam）。
//!
//! 自 qtcloud-connect CLI 随业务迁入（issue #1）：话术内容是招聘域的
//! 业务资产，沟通云只保留发送通道。模板渲染机制由 qtcloud-connect-send 提供。

use qtcloud_connect_send::mail::MailTemplate;
...
mod tests {
    use super::*;
    use qtcloud_connect_send::mail::render_template;
